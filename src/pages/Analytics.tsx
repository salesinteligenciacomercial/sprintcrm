...
const DATA = {
  ...
  pilares: [
    ...
    { name: "BPO Comercial", icon: "⚙️", score: 62, color: "#6366f1", rows: [["Win Rate", "31.4%"], ["Ciclo médio", "16 dias"], ["Sales Velocity/dia", "R$ 2.810"], ["Gargalo", "Comparecimento"], ["Conv. comparec.", "53.3%"]], alert: "53% de comparecimento — lembretes automáticos podem recuperar +R$ 8k/mês." },
